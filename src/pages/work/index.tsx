  ...
  return (
    <>
      <Layout>
        ...
        <figure className="w-full h-full absolute z-10 overflow-hidden justify-between mt-[500px] flex flex-row">
          <img src="/asets/img/cloud.png" className="min-w-max h-full md:-ml-[800px] -ml-[1000px] md:mx-0" style={{ translate: (scrollTop * 2.6 + 'px') }} />
          <img src="/asets/img/cloud.png" className="w-full h-fit  md:ml-[500px] -ml-40" style={{ translate: (-scrollTop * 2.9 + 'px') }} />
        </figure>
        <div className="w-full h-fit flex flex-shrink-0 flex-col overflow-hidden">
          ...
          <div className="w-screen h-fit min-h-screen xl:max-h-[800px] bg-fixed bg-center overflow-x-hidden overflow-y-hidden" style={{ backgroundImage: 'url(/asets/img/work/parallax/sky.png)' }} >
            ...
            <img src="/asets/img/work/parallax/tree.png" alt="mountain" className='max-w-max items-center -ml-80 xl:-mr-0 z-40 h-1/2 xl:h-screen relative md:hidden -mt-[330px] xl:-mt-[1200px]' style={{ transform: `translateX(${scrollTop * 0.5}px)` }} />
          ...
          <div className="w-full h-fit min-h-screen flex flex-col bg-fixed bg-center z-10 overflow-x-hidden" style={{ backgroundImage: 'url(/asets/img/work/parallax/sky2.png)' }}>
          .
          </div>
        </div>
      </Layout>

...
const Parallax: React.FC = () => {
    ...
    return (
        <div className="w-full  flex flex-col opacity-20 h-[1800px] md:h-[900px] md:-mt-96 -mt-[470px] z-0 md:py-20 items-center justify-center gap-10 overflow-x-hidden overflow-y-clip absolute ">

...
const Footer: React.FC = () => {
  return (
    <>
      <div className="w-full z-40 h-fit flex flex-col">
        <div className="w-full h-fit py-3 md:px-20 px-2 bg-neutral flex items-center justify-center md:justify-end text-neutral-content">
          <section className=' w-full md:w-2/3 px-3 flex flex-col items-center md:flex-row gap-3'>
            <h1 className='h3 h-full '>Interested working with me?
            </h1>
            <Link to='mailto:rizkyrahmat292@gmail.com' className=' bg-neutral-content itmes-center justify-between flex flex-row rounded-md shadow-md px-4 py-2 text-[#171f1f] font-semibold'><p className='m-auto px-2'>Email Me </p>  <MdOutlineMailOutline className='text-3xl font-bold' /></Link>
          </section>
        </div>

        <footer className="footer  items-center overflow-hidden p-4 md:pr-32 bg-neutral text-neutral-content">
          <aside className="items-center grid-flow-col">
            ...
            <p>© 2023 Rizky Rahmat - All right reserved</p>
          </aside>

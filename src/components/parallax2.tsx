...
const Parallax2: React.FC = () => {
    ...
    return (
        <div className="w-full  flex flex-col -mt-40 md:-mt-0 -ml-4 opacity-50 h-[1800px] md:-right-40 md:h-[900px] top-0 z-0 md:py-20 items-center justify-center gap-10 overflow-x-hidden overflow-y-clip absolute ">
            <img src="/asets/img/polygon.png" alt="alt" className='w-20 h-fit md:-mr-96' style={{ transform: `translateX(${-scrollTop * 0.91}px) translateY(${scrollTop * 0.72}%) rotate(${scrollTop * 0.4}deg) ` }} />
            <div className="flex flex-row">
                <img src="/asets/img/rectangle.png" alt="alt" className='w-20 h-fit md:-mr-96' style={{ transform: `translateX(${scrollTop * 0.21}px) translateY(${scrollTop * 0.40}%) rotate(${scrollTop * 0.5}deg) ` }} />
                <img src="/asets/img/polygon.png" alt="alt" className='w-20 h-fit md:ml-96' style={{ transform: `translateX(${scrollTop * 0.21}px) translateY(${scrollTop * 0.23}%) rotate(${scrollTop * 0.1}deg) ` }} />
            </div>

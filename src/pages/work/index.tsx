      ...
      <Layout>
        ...
        <div className="w-full h-fit flex flex-shrink-0 flex-col overflow-hidden" id="workCover">
          ...
          <div className="w-screen h-fit min-h-screen xl:max-h-[800px] bg-fixed bg-center overflow-x-hidden overflow-y-hidden" style={{ backgroundImage: 'url(/asets/img/work/parallax/sky.png)' }} >
            <img src="/asets/img/work/parallax/sun.png" alt="mountain" className='w-full z-[3] mb-40 -mt-40 right-0 xl:flex hidden h-fit  ' style={{ transform: `translateX(${-scrollTop * 0.2}px) translateY(${scrollTop * 2.22}px) rotate(${scrollTop * 0.1}deg) scale(${150 + scrollTop * 0.8}%)` }} />
            ...
            <img src="/asets/img/work/parallax/tree.png" alt="mountain" className='max-w-max items-center -mr-96 xl:-mr-0 z-40 h-1/2  sm:hidden xl:grid xl:h-screen relative xl:-mt-[1200px]' style={{ transform: `translateX(${-scrollTop * 0.5}px)` }} />

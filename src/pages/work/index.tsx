    ...
    <>
      <Layout>
        ...
        <div className="w-full min-h-screen bg-black text-[#f9f5f5] flex-col overflow-x-hidden overflow-y-scroll" id="workCover">
          ...
          <div className="w-full pb-20 h-fit pt-4 md:pt-20 z-30 flex flex-col bg-[#171f1f] overflow-x-hidden" style={{ opacity: `${scrollTop / 9}%` }} >
            <h1 className="h2 w-full px-3 md:px-20"><b className="h1 font-black px-3">#</b> Project</h1>
            <nav className="w-full flex py-4 px-2 md:justify-center md:gap-10 flex-row justify-between">
              <button className="h4 w-fit px-3 py-2 border-b-2 border-[#f9f5f5]">Websites</button>
              <button className="h4 w-fit px-3 py-2 border-b-2 border-[#f9f5f5]">Aplication</button>
              <button className="h4 w-fit px-3 py-2 border-b-2 border-[#f9f5f5]">Web Design</button>
            </nav>
            <div className="w-fit h-fit grid grid-cols-1 gap-3 my-3 mx-auto px-2 md:grid-cols-3">
              
              <div className="card w-full md:w-96 bg-base-100 shadow-xl image-full">
                <figure><img src="/asets/img/hero.jpg" alt="Shoes" /></figure>
